      ...
      <div id="common-select-container">
        ...
        <div id="select-container">
          ...
          <div id="category-container">
            ...
            <div className="checkboxgroup">
              <img alt="" className="food-icon" src="./food_icon/nigiri.png"></img>
            ...
            <div className="checkboxgroup">
              <img alt="" className="food-icon" src="./food_icon/chinese.png"></img>
            ...
            <div className="checkboxgroup">
              <img alt="" className="food-icon" src="./food_icon/steak.png"></img>
            ...
            <div className="checkboxgroup">
              <img alt="" className="food-icon" src="./food_icon/fishcake.png"></img>
            ...
            <div className="checkboxgroup">
              <img alt="" className="food-icon" src="./food_icon/soju.png"></img>
            ...
            <div className="checkboxgroup">
              <img alt="" className="food-icon" src="./food_icon/macaron.png"></img>
